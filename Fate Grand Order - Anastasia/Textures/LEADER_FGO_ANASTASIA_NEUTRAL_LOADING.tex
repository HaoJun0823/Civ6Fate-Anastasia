...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="F:\Mods\CIV\2022\ANA\ChiTu\PNG\LEADER_FGO_ANASTASIA_NEUTRAL_LOADING.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2525166931</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_FGO_ANASTASIA_NEUTRAL_LOADING.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_FGO_ANASTASIA_NEUTRAL_LOADING"/>
	<m_Description text=""/>
	<m_Tags>
